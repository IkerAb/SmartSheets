  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 gap-6 max-w-lg mx-auto">
      ...
      <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-8 w-full text-center">
        ...
        {datasetId && (
          <p className="text-emerald-400 text-xs mb-3 font-mono">Activo: {datasetId.slice(0, 8)}…</p>
        )}
      ...
      <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-8 w-full text-center">
        ...
        {promoId && (
          <p className="text-emerald-400 text-xs mb-3 font-mono">Activo: {promoId.slice(0, 8)}…</p>
        )}
  ...
  function renderPage() {
    switch (activePage) {
      ...
      case "upload":
        return (
          <UploadPage
            onDatasetLoaded={(id) => { setDatasetId(id); setActivePage("dashboard"); }}
